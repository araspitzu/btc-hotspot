...
## TODO: add systemd entry for eclair

## TODO: add eclair conf

echo -e "########  DOWNLOAD btc-hotspot   #########"
wget https://github.com/araspitzu/btc-hotspot/releases/download/v0.0.5-alpha/btc-hotspot_0.0.5-alpha_all.deb
sudo dpkg -i btc-hotspot_0.0.5-alpha_all.deb
